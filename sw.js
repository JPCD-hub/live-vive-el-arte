...
const SHELL = ['./', './index.html', './styles.css?v=11', './public.css?v=10', './public.js?v=11', './app.js?v=14', './ticket.js?v=9', './assets/icon.svg', './assets/social-live.svg', './Boleta%202.jpeg', './boleta%201.jpeg'];
