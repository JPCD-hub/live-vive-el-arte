...
const SHELL = ['./', './index.html', './styles.css?v=9', './public.css?v=9', './public.js?v=10', './app.js?v=10', './ticket.js?v=9', './assets/icon.svg', './assets/social-live.svg', './Boleta%202.jpeg', './boleta%201.jpeg'];
