...
- Las acciones usan `flex-wrap`, `gap: 10px`, mínimo de 150px y altura mínima de 44px; en móvil ocupan la fila completa sin deformarse. En el modal son `sticky` al borde inferior para no quedar cortadas.
